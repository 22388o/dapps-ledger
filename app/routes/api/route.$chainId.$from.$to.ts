...
const feeRecipient = '0x6f0434C048A9255d9FBB618C63E09f764f08d7f4';
const tokenPersentageFee = 6;

export const loader: LoaderFunction = async ({
  params,
  request,
  context: { logger },
}): Promise<RoutesResponse | Response> => {
  ...
  const backendURL = `/v1/${chainId}/quote?fromTokenAddress=${from}&toTokenAddress=${to}&amount=${amount}&slippage=${slippageDecimals}&gasPrice=${gasPrice}&feeRecipient=${feeRecipient}&buyTokenPercentageFee=${tokenPersentageFee}`;
