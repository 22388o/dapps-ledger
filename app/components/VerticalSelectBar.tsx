...
export const VerticalSelectBar = typedMemo(function <T>({
  ...
  return (
    ...
    >
      ...
      {isCustomAvailable ? (
        ...
        >
          ...
          <div>
            {customDescription && (
              <span
                className={clsx(
                  ...
                  isCustomActive && 'text-[#BEF8DD] dark:text-[#00A662]'
                )}
              >
                {customDescription}
              </span>
            ...
            <NumberFormat
              className={clsx(
                'max-w-[65px] text-sm bg-transparent outline-none overflow-visible text-right text-gray placeholder:text-gray',
      ...
      <motion.div
        className={clsx(
          'rounded-2lg py-5 text-center absolute top-[-1px] z-[1] h-10 w-[calc(100%+2px)] left-[-1px] bg-cgreen !m-0',
          'dark:bg-cgreenDark',
